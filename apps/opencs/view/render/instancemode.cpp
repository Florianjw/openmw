...
: EditMode (worldspaceWidget, QIcon (":scenetoolbar/instance-editing"), Mask_Reference | Mask_Terrain, "Instance editing",
...
void CSVRender::InstanceMode::activate (CSVWidget::SceneToolbar *toolbar)
{
    if (!mSubMode)
    {
        ...
        mSubMode->addButton (":scenetoolbar/rotate", "rotate",
        ...
        mSubMode->addButton (":scenetoolbar/scale", "scale",
